...
public class PartCageLamp extends PartLamp {
    ...
    public List<Cuboid> getSelectionBoxes() {
        ...
        boxes.add(new Cuboid(3 / 16D, 0.0, 3 / 16D, 13 / 16D, 2 / 16D, 1.0 - 3 / 16D));
        boxes.add(new Cuboid(4 / 16D, 2 / 16D, 4 / 16D, 12 / 16D, 12 / 16D, 12 / 16D));
    ...
    public void renderGlow(int pass) {
        ...
        Cuboid vector = new Cuboid(5 / 16D, 2 / 16D, 5 / 16D, 11 / 16D, 11 / 16D, 11 / 16D);
